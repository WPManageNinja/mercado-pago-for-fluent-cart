...
namespace MercadoPagoFluentCart\PluginManager;
...
class Updater
{
    ...
    private function maybe_delete_transients()
    {
        ...
        if (isset($_GET['mercado-pago-for-fluent-cart-check-update'])) {
            if (current_user_can('update_plugins')) {
                $this->delete_transients();
                ...
                wp_redirect(admin_url('plugins.php?s=mercado-pago-for-fluent-cart&plugin_status=all'));
                exit();
            }
        }
    }
