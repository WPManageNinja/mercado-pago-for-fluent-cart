...
class MercadoPagoGateway extends AbstractPaymentGateway
{
    ...
    {
        $betaNotice = __('Mercado Pago payment gateway is currently in beta. Test properly before going live!', 'mercado-pago-for-fluent-cart');
        return [
            'notice' => [
           ...
           'beta_notice' => [
                'value' => '<p class="text-gray-500" style="display:flex; align-items: center; gap: 5px;">
